...
int main()
{
    ...
    ll.display();
    cout << "Length of the list " << ll.length() << endl;
    cout << "Deleted element is from begin " << ll.deleteatbegin() << endl;
    cout << "Deleted element is from end " << ll.deleteatlast() << endl;
    cout << "Deleted element at positon i  " << ll.deleteatindex(2) << endl;
    ll.display();
